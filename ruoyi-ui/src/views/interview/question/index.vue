<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="问题提示信息" prop="questionPrompt">
        <el-input
          v-model="queryParams.questionPrompt"
          placeholder="请输入问题提示信息"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="questionList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="问题序号" align="center" prop="questionNo" />
      <el-table-column label="问题内容" align="center" prop="content" />
      <el-table-column label="问题提示信息" align="center" prop="questionPrompt" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="问题序号" prop="questionNo">
              <el-input v-model="form.questionNo" placeholder="请输入问题序号" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="24">
            <el-form-item label="问题提示信息" prop="questionPrompt">
              <el-input v-model="form.questionPrompt" placeholder="请输入问题提示信息" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除面试问题编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('interview/question/export', {
        ...this.queryParams
