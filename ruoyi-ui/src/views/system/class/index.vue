<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="classList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="开班时间" align="center" prop="beginDate" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.beginDate, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="班级人数" align="center" prop="studentCount" />
      <el-table-column label="班级地址" align="center" prop="address" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="班级地址" prop="address">
              <el-input v-model="form.address" placeholder="请输入班级地址" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        address: [
          { required: true, message: "班级地址不能为空", trigger: "blur" }
        ],
      }
    }
  },
