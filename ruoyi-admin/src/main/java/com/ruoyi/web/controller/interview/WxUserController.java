...
public class WxUserController extends BaseController
{
     ...
     * 查询小程序用户列表
     */
    @PreAuthorize("@ss.hasPermi('interview:user:list')")
    @GetMapping("/list")
     ...
     * 导出小程序用户列表
     */
    @PreAuthorize("@ss.hasPermi('interview:user:export')")
     ...
     * 获取小程序用户详细信息
     */
    @PreAuthorize("@ss.hasPermi('interview:user:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增小程序用户
     */
    @PreAuthorize("@ss.hasPermi('interview:user:add')")
     ...
     * 修改小程序用户
     */
    @PreAuthorize("@ss.hasPermi('interview:user:edit')")
     ...
     * 删除小程序用户
     */
    @PreAuthorize("@ss.hasPermi('interview:user:remove')")
